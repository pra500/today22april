...
//scenario:
//    i want to take data from a input box that i sent to it through snedkeys()..i m using gettext()... is this  correct :
//
//            | Element Type       | Method                  |
//            | ------------------ | ----------------------- |
//            | input / textbox    | `getAttribute("value")` |
//            | div / label / span | `getText()`             |
//
///
    //
    //
    //getAttribute("value"): we have to use here
