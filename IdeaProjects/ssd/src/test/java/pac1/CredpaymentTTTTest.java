...
public class CredpaymentTTTTest {
    ...
    public void setup() {
      ...
      //  driver.get("https://www.cult.fit/");
        driver.get("https://dribbble.com/search/cart-page");
    ...
    public void titleTest() {
        ...
        String title=
                driver.getTitle();
        Assert.assertEquals(title, "Get the Best Fitness Workouts, Gyms and Sports in India | cult.fit");
